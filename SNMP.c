...
XS(XS_SNMP_constant)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: SNMP::constant(name,arg)");
    {
...
XS(XS_SNMP__new_session)
{
    dXSARGS;
    if (items != 6)
	croak("Usage: SNMP::_new_session(version, community, peer, port, retries, timeout)");
    {
	char *	version = (char *)SvPV(ST(0),na);
	char *	community = (char *)SvPV(ST(1),na);
	char *	peer = (char *)SvPV(ST(2),na);
...
XS(XS_SNMP__add_mib_dir)
{
    dXSARGS;
    if (items < 1 || items > 2)
	croak("Usage: SNMP::_add_mib_dir(mib_dir,force=0)");
    {
	char *	mib_dir = (char *)SvPV(ST(0),na);
	int	force;
	int	RETVAL;
...
XS(XS_SNMP__read_mib)
{
    dXSARGS;
    if (items < 1 || items > 2)
	croak("Usage: SNMP::_read_mib(mib_file, force=0)");
    {
	char *	mib_file = (char *)SvPV(ST(0),na);
	int	force;
	int	RETVAL;
...
XS(XS_SNMP__read_module)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: SNMP::_read_module(module)");
    {
	char *	module = (char *)SvPV(ST(0),na);
	int	RETVAL;
#line 970 "SNMP.xs"
        {
	SV *verbose;
...
XS(XS_SNMP__set)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: SNMP::_set(sess_ref, varlist_ref)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	SV *	varlist_ref = ST(1);
...
XS(XS_SNMP__get)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: SNMP::_get(sess_ref, retry_nosuch, varlist_ref)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
...
XS(XS_SNMP__getnext)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: SNMP::_getnext(sess_ref, varlist_ref)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	SV *	varlist_ref = ST(1);
...
XS(XS_SNMP__get_type)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: SNMP::_get_type(tag)");
    {
	char *	tag = (char *)SvPV(ST(0),na);
	char *	RETVAL;
#line 1356 "SNMP.xs"
	{
	   struct tree *tp  = NULL;
...
XS(XS_SNMP__dump_packet)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: SNMP::_dump_packet(flag)");
    {
...
XS(XS_SNMP__map_enum)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: SNMP::_map_enum(tag)");
    {
	char *	tag = (char *)SvPV(ST(0),na);
	char *	RETVAL;
#line 1382 "SNMP.xs"
...
XS(XS_SNMP__translate_obj)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: SNMP::_translate_obj(var,mode,use_long)");
    {
...
XS(XS_SNMP__sock_cleanup)
{
    dXSARGS;
    if (items != 0)
	croak("Usage: SNMP::_sock_cleanup()");
    {
#line 1451 "SNMP.xs"
	{
	   SOCK_CLEANUP;
...
XS(XS_SnmpSessionPtr_DESTROY)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: SnmpSessionPtr::DESTROY(sess_ptr)");
    {
	SnmpSession *	sess_ptr;

	if (SvROK(ST(0))) {
	    IV tmp = SvIV((SV*)SvRV(ST(0)));
	    sess_ptr = (SnmpSession *) tmp;
	}
	else
	    croak("sess_ptr is not a reference");
#line 1460 "SNMP.xs"
	{
           snmp_close( sess_ptr );
	}
